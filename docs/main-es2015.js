...
let AddComponent = class AddComponent {
    ...
    ngOnInit() {
        ...
        this.weather.getWeather(this.city).subscribe(response => {
            console.log(response);
            this.weather = response;
        });
        this.http.get('https://restcountries.eu/rest/v2/all').pipe((Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])())).subscribe((countries) => {
